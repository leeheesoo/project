...
import com.cetaphilevent.repository.body.BodyChallengeUserRepository;
import com.cetaphilevent.util.EventServiceException;

@Service
public class BodyChallengeUserServiceImpl implements BodyChallengeUserService {
	
	@Autowired
	private BodyChallengeUserRepository repository;

	@Override
	public Long save(BodyChallengeUserDao entry) {
		// TODO Auto-generated method stub
		BodyChallengeUserDao user = repository.save(entry);
		return user.getId();
	}
	...
	public void update(Long userId, String snsType) throws EventServiceException {
		// TODO Auto-generated method stub
		BodyChallengeUserDao user = repository.findOne(userId);
		if (user == null) {
