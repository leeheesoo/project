...
{
    public class OverFortyFiveService : IOverFortyFiveService
    {
        private IOverFortyFiveDbEntryRepository repo;

        public OverFortyFiveService(IOverFortyFiveDbEntryRepository repo) {
            this.repo = repo;
        }
        ...
        public OverFortyFiveDbEntry CreateOverFortyFiveEntry(OverFortyFiveDbEntry entry)
        {
        ...
        public int getEntryCount() {
            return repo.GetAll().Where(x => x.UpdateDate.HasValue).Count();
        }



        public IQueryable<OverFortyFiveDbEntry> GetAdminOverFortyFiveEntryList()
        {
