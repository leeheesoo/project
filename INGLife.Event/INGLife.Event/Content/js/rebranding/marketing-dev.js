...
function setMarketingKmcData(data) {
    $('#RebrandingMarketingModel_Name').val(data.Name);
    $('#RebrandingMarketingModel_Mobile').val(data.Mobile);
    $('#RebrandingMarketingModel_BirthDay').val(data.BirthDay);
    if (data.Gender === "0") {
...
var rebrandingEventView = new Vue({
    el: '#rebranding-marketing-event',
    methods: {
        beginEntry: function () {
            $('.loading').show();
        },
        ...
        openPostCode: function () {
            ...
            new daum.Postcode({
                oncomplete: function (data) {
                    ...
                    $('#RebrandingMarketingModel_ZipCode').val(data.zonecode);
                    $('#RebrandingMarketingModel_Address').val(fullAddr);
                    ...
                    $('#RebrandingMarketingModel_AddressDetail').focus();
