...
$(function () {
	...
	// 동의함 체크시 팝업open
	// =================================================   
	var $agree01 = $("#MarketingAgree01");
	var $agree02 = $("#MarketingAgree02");
	var $disagree01 = $("#MarketingDisagree01");
	var $disagree02 = $("#MarketingDisagree02");
	...
	// 주소,이메일 제어
	$('.contact-check input[type="checkbox"]').change(function () {
		var $email = $('.email-wrap');
		var $address = $('.address-wrap');
		$email.hide();
		$address.hide();

		var checkValues = $('.contact-check input[type=checkbox]:checked').map(function (i, e) {
