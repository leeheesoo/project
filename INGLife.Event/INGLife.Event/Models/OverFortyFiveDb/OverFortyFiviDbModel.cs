...
namespace INGLife.Event.Models.OverFortyFiveDb
{

    public class OverFortyFiviDbModels
    {
        public OverFortyFiviDbModel MarketingAgreeModel { get; set; }
        public RequestKMCModel RequestKMCModel { get; set; }
    }

    public class OverFortyFiviDbModel
    {
        [Display(Name = "이름")]
