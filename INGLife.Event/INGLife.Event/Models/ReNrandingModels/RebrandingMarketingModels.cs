...
namespace INGLife.Event.Models.ReNrandingModels {
    public class RebrandingMarketingModels {
        public RebrandingMarketingModel RebrandingMarketingModel { get; set; }
        public RequestKMCModel RequestMarketingKMCModel { get; set; }
    }
    public class RebrandingMarketingModel {
        [Display(Name = "이름")]
        ...
        [AssertThat("PhoneCheck == true", ErrorMessage = "전화,문자,우편 수신 동의를 하셔야\n이벤트 참여가 가능합니다.")]
        public bool PhoneCheck { get; set; }
        [Display(Name = "연락방식-문자메세지")]
        [AssertThat("MessageCheck == true", ErrorMessage = "전화,문자,우편 수신 동의를 하셔야\n이벤트 참여가 가능합니다.")]
        public bool MessageCheck { get; set; }
        [Display(Name = "연락방식-우편")]
        [AssertThat("PostCheck == true", ErrorMessage = "전화,문자,우편 수신 동의를 하셔야\n이벤트 참여가 가능합니다.")]
        ...
        [Display(Name = "상세주소")]
        [Required(ErrorMessage = "나머지주소를 입력해주세요.")]
