...
{
    public class FinancialConsultantSharingOriginCreateModel
    {
        [Display(Name = "이름")]
        ...
        [AssertThat("PhoneCheck == true", ErrorMessage = "전화와 문자메시지 수신 동의와 주소 입력을 완료 하셔야 이벤트 참여가 가능합니다.")]
        public bool PhoneCheck { get; set; }
        [Display(Name = "연락방식-문자메세지")]
        [AssertThat("MessageCheck == true", ErrorMessage = "전화와 문자메시지 수신 동의와 주소 입력을 완료 하셔야 이벤트 참여가 가능합니다.")]
        public bool MessageCheck { get; set; }
        [Display(Name = "연락방식-우편")]
        [AssertThat("PostCheck == true", ErrorMessage = "전화와 문자메시지 수신 동의와 주소 입력을 완료 하셔야 이벤트 참여가 가능합니다.")]
