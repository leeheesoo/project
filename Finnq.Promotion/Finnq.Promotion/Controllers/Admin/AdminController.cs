...
using Finnq.Promotion.Models.AdminModels;
...
namespace Finnq.Promotion.Controllers.Admin {
    [RoutePrefix("manager")]
    ...
    public class AdminController : Controller {
        ...
        public AdminController(IAuthenticationManager authManager, AppUserManager userManager, AppRoleManager roleManager) {
