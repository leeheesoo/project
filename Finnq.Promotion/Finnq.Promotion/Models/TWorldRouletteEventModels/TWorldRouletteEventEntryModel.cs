...
namespace Finnq.Promotion.Models.TWorldRouletteEventModels {
    public class TWorldRouletteEventEntryModel {
        [Display(Name = "이름")]
    ...
    public class UpdateTWorldRouletteEventEntryModel {
        public long id { get; set; }
    }

    public class TWorldRouletteEventInstantLotteryViewModel {
        public long id { get; set; }
