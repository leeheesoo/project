var tRouletteEntryModel = new Vue({
    el: '#t-roulette-entry',
    data: {
        data: [],
        dataFilters: {
    ...
    methods: {
        goToPage: function (pageNumber) {
            ...
            $.ajax({
                url: '/api/t-roulette/admin-entry-list',
                type: 'get',
        ...
        excelDownload: function () {
            location.href = '/manager/t-roulette/download?' + $.param(this.dataFilters);
        }
    }
});

var tRoulettePrizeSettingModel = new Vue({
    el: '#t-roulette-prize-setting',
    data: {
        data:[],
        showLoading: false
    },
    ...
    methods: {
        ...
        updateRoulettePrizeSetting:function(entry){
            $.ajax({
                url: '/api/t-roulette/update-prize',
                type: 'post',
                data: {
                    date: entry.Date,
        ...
        goToPage: function () {
            $.ajax({
                url: '/api/t-roulette/admin-prize-list',
                type: 'get',
                success: function (res) {
                    this.data = res;
                }.bind(this)
