var rouletteEntryModel = new Vue({
    el: '#roulette-entry',
    data: {
        data: [],
        dataFilters: {
    ...
    methods: {
        goToPage: function (pageNumber) {
            ...
            $.ajax({
                url: '/api/roulette/admin-entry-list',
                type: 'get',
        ...
        excelDownload: function () {
            location.href = '/manager/roulette/download?' + $.param(this.dataFilters);
        }
    }
});

rouletteEntryModel.goToPage(1);

var roulettePrizeSettingModel = new Vue({
    el: '#roulette-prize-setting',
    data: {
        data:[],
        showLoading: false
    },
    ...
    methods: {
        ...
        goToPage: function () {
            $.ajax({
                url: '/api/roulette/admin-prize-list',
                type: 'get',
                success: function (res) {
                    this.data = res;
                }.bind(this)
...
roulettePrizeSettingModel.goToPage();