namespace Finnq.Promotion.Domain.Migrations
{
    ...
    public partial class createtrouletteevent : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.TRouletteEventEntries",
                c => new
                    {
            ...
            CreateTable(
                "dbo.TRouletteEventInstantLotteryPrizeSettings",
                c => new
                    {
        ...
        {
            DropTable("dbo.TRouletteEventInstantLotteryPrizeSettings");
            DropTable("dbo.TRouletteEventEntries");
        }
    }
}
