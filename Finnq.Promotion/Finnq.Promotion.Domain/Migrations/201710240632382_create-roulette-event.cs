namespace Finnq.Promotion.Domain.Migrations
{
    ...
    public partial class createrouletteevent : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.RouletteEventEntries",
                c => new
                    {
            ...
            CreateTable(
                "dbo.RouletteEventInstantLotteryPrizeSettings",
                c => new
                    {
        ...
        {
            DropTable("dbo.RouletteEventInstantLotteryPrizeSettings");
            DropTable("dbo.RouletteEventEntries");
        }
    }
}
