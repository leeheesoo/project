...
@NoArgsConstructor
@AllArgsConstructor
public class RenewalExperienceDTO {
	...
	@Min(value=2016,message="아이생일을 정확하게 입력해주세요.")
	@Max(value=2018,message="아이생일을 정확하게 입력해주세요.")
	@Order(13)
	...
	@NotBlank(message="제품단계를 선택해주세요.")
	@Order(15)
	private String proudctSteps;
	@NotBlank(message="수유방식을 선택해주세요.")
	@Order(1)
	private String feedingType;
	@NotBlank(message="사용중인 제품을 입력해주세요.")
	@Length(max=20,message="사용중인 제품을 20자이내로 입력해주세요.")
	@Order(2)
	private String usedProduct;
	@NotBlank(message="제품 선택 시 가장 중요하게 생각하는 점을 선택해주세요.")
	@Length(max=50,message="제품 선택시 가장 중요하게 생각하는 점을 50자이내로 입력해주세요.")
	@Order(3)
	private String selectPoint;
	@Length(max=50,message="제품 선택시 가장 중요하게 생각하는 점을 50자이내로 입력해주세요.")
	@Order(4)
	private String selectPoint2;
