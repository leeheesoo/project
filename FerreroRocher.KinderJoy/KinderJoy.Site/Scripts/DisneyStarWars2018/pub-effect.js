...
var sceneBack = $('.item.back'),
    ...
    sceneCenterDeco = $('.item.center-deco'),
    tl = new TimelineLite();
...
function getSceneAnamation() {
    ...
    sceneTimeline
        ...
        .from(sceneBack, 0.6, { top: -400 }, "start") // 뒷배경
        .from(sceneSky, 3, { alpha: 1 }, 'start') // 하늘
        .from(sceneCenter, 0.5, { top: 650 }, "-=2.7") //가운데
        .from(sceneCenterDeco, 0.5, { top: 650 }, "-=2.7") //가운데
