...
namespace KinderJoy.Site.Models.KittyJusticeleage {
    //public class KittyJusticeLeagueModels {
    //    KittyJusticeLeagueGiftyConModel KittyJusticeLeagueGiftyConModel { get; set; }
    //    KittyJusticeLeagueAddressModel KittyJusticeLeagueAddressModel { get; set; }
    //}
    public class KittyJusticeLeagueModel {
    ...
    //public class KittyJusticeLeagueAddressModel : KittyJusticeLeagueGiftyConModel {
      
    //}
    public class KittyJusticeLeagueInstantLotteryViewModel {
        public long Id { get; set; }
        public KittyJusticeLeagueInstantLotteryPrizeType PrizeType { get; set; }
