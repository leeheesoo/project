namespace KinderJoy.Domain.Migrations
{
    ...
    public partial class CreateDisneyStarWars : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.DisneyStarWars2018InstantLottery",
                c => new
                    {
            ...
            CreateTable(
                "dbo.DisneyStarWars2018InstantLotteryPrizeSetting",
                c => new
                    {
        ...
        {
            DropTable("dbo.DisneyStarWars2018InstantLotteryPrizeSetting");
            DropTable("dbo.DisneyStarWars2018InstantLottery");
        }
    }
}
