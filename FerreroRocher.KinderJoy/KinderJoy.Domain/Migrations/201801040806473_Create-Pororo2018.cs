namespace KinderJoy.Domain.Migrations
{
    ...
    public partial class CreatePororo2018 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.Pororo2018InstantLottery",
                c => new
                    {
            ...
            CreateTable(
                "dbo.Pororo2018InstantLotteryPrizeSetting",
                c => new
                    {
        ...
        {
            DropTable("dbo.Pororo2018InstantLotteryPrizeSetting");
            DropTable("dbo.Pororo2018InstantLottery");
        }
    }
}
